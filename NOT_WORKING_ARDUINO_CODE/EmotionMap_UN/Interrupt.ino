...
//  OCR1A = 0x9B0;      // SET THE TOP OF THE COUNT TO 2480 FOR 25Hz SAMPLE RATE
  OCR1A = 0x3070;      // SET THE TOP OF THE COUNT TO 12400 FOR 5Hz SAMPLE RATE
...
//    sampleCounter += 40;                         // keep track of the time in mS with this variable
